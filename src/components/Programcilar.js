...
export default function Programcilar() {
  ...
  const [idler, setIdler] = useState(null);
  ...
  const stil = {
    fontSize: "1.5em",
    marginTop: "0.5em",
    color: idler !== null ? "gold" : "royalblue", // 🤔 kutlarken renk gold'a dönecek
  };
      ...
      <div className="programmers">
        {
          ...
          programcilar.map((dev) => (
            <div className="programmer" key={dev.id}>
              ...
              <button
                onClick={() => {
                  /* burada dev.id 'yi öne çıkan id'ye atayın */ setIdler(
                    dev.id
                  );
                }}
              >
